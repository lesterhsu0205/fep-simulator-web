...
export default function FileUploadForm({
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<FileUploadFormData>({
    defaultValues: {
      action: 'CREATE',
    },
  })
              ...
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  >
                    {uploadError
                      ? '上傳失敗'
                      : uploadResult?.messageCode === '00000' ? '上傳成功' : '上傳失敗'}
                  </h3>
                    ...
                    <div className="bg-base-200 rounded-lg p-3 flex gap-4">
                      ...
                      <div className="w-3/12 flex-shrink-0">
                        <div className="text-sm">
                          {renderContent(uploadResult.messageContent, 0, true)}
                        </div>
                      </div>
